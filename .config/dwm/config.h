...
#else
static const char *fonts[]               = { "Liberation Mono:pixelsize=10:antialias=true:autohint=true" };
#endif // BAR_PANGO_PATCH
static const char dmenufont[]            = "Liberation Mono:pixelsize=10:antialias=true:autohint=true";
